...
description: "Creates a styled checkbox with animation on state change."
logo: "mdx.png"
---

-   Use an element to create the check and insert it via the element to create a reusable SVG icon.
-   Create a .checkbox-container and use flexbox to create the appropriate layout for the checkboxes.
-   Hide the element and use the label associated with it to display a checkbox and the provided text.
